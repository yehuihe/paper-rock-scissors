...
from _base import MoveChoice, Outcome, ListInstanceMixin, BaseMode
...
class GameEnvironment(ListInstanceMixin):
    ...
    def __init__(
            ...
            verbose=0,
            winner=None):
        self._first_player = factory.make_first_player()
        self._second_player = factory.make_second_player()
